...
class AddNewAddressWidget extends StatefulWidget {
  ...
  static String routePath = '/addNewAddress';
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            FlutterFlowDropDown<String>(
                              ...
                              options: [
                                FFLocalizations.of(context).getText(
                                  'jno3uh9a' /* Kigali City */,
                                ),
                                FFLocalizations.of(context).getText(
                                  'rc1fqqmn' /* Nothern Province */,
                                ),
                                FFLocalizations.of(context).getText(
                                  'dwikrx3m' /* Southern Province */,
                                ),
                                FFLocalizations.of(context).getText(
                                  'c6zdhnjc' /* Western Province */,
                                ),
                                FFLocalizations.of(context).getText(
                                  'the8l4b8' /* Eastern Province */,
                                )
                              ],
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model
                                    .districtTextControllerValidator
                                    .asValidator(context),
                                inputFormatters: [
                                  if (!isAndroid && !isiOS)
                                    TextInputFormatter.withFunction(
