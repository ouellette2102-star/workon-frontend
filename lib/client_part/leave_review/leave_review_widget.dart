...
class _LeaveReviewWidgetState extends State<LeaveReviewWidget> {
  ...
  void initState() {
    ...
    _model.reviewMessageTextController1 ??= TextEditingController();
    _model.reviewMessageFocusNode1 ??= FocusNode();

    _model.reviewMessageTextController2 ??= TextEditingController();
    _model.reviewMessageFocusNode2 ??= FocusNode();
  }
              ...
              children: [
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'fnnpkuit' /* How was your experience about ... */,
                                      ),
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'lld1is9y' /* What best describes your exper... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                  ...
                                  FlutterFlowChoiceChips(
                                    options: [
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        'upi5af0h' /* Met expectations */,
                                      )),
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        '8zdncwnt' /* Worth the price */,
                                      )),
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        'y3x5msd7' /* Solved my problem */,
                                      )),
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        '4xcsqruz' /* Easy to book */,
                                      )),
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        '7jbqsrn6' /* Quick response */,
                                      )),
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        'clg478s9' /* Will use again */,
                                      ))
                                    ],
                              ...
                              Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.reviewMessageTextController1,
                                      focusNode: _model.reviewMessageFocusNode1,
                                      autofocus: false,
                                      textCapitalization:
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'vttzbypw' /* What did you like or not like ... */,
                                        ),
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'gsysypqm' /* How was your experience with L... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'kaz4wbkr' /* What stood out the most? */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                  ...
                                  FlutterFlowChoiceChips(
                                    options: [
                                      ...
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        'xayi6aiu' /* Well-equipped */,
                                      )),
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        'edya0wnx' /* Good communication */,
                                      )),
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        'aaoqlt0g' /* Would recommend */,
                                      ))
                                    ],
                                    onChanged: (val) => safeSetState(
                              ...
                              Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.reviewMessageTextController2,
                                      focusNode: _model.reviewMessageFocusNode2,
                                      autofocus: false,
                                      textCapitalization:
                                          TextCapitalization.words,
                                      textInputAction: TextInputAction.next,
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'sf408xy7' /* What did you like or not like ... */,
                                        ),
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                ...
                wrapWithModel(
                  ...
                  child: SuccessWidgetWidget(
                    title: FFLocalizations.of(context).getText(
                      'ivo53tpr' /* Thank you for your feedback! */,
                    ),
                    description: FFLocalizations.of(context).getText(
                      'tv5gw7pb' /* Your feedback helps us maintai... */,
                    ),
                ...
                wrapWithModel(
                  ...
                  child: FailedWidgetWidget(
                    title: FFLocalizations.of(context).getText(
                      'v6auv829' /* Sorry!  Failed to submit your ... */,
                    ),
                    description: FFLocalizations.of(context).getText(
                      '5fmwcpcv' /* Sorry! Something went wrong wh... */,
                    ),
                    btnText: FFLocalizations.of(context).getText(
                      'a9pnc2ur' /* Try again */,
                    ),
